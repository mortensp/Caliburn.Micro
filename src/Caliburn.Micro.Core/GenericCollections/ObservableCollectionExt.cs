...
namespace Caliburn.Micro.GenericCollections
{
    // tilføjet af mspa
    /// <summary>
    ...
    public class ObservableCollectionExt<T> : ObservableCollection<T>, INotifyPropertyChanged where T : INotifyPropertyChanged
    {
        #region Public Constructors
            /// <summary>
            /// Initializes a new instance of the ObservableCollectionExt class.
            /// </summary>
            ...
            /// <summary>
            /// Initializes a new instance of the ObservableCollectionExt class that contains elements copied from the
            /// specified list.
            /// </summary>
            /// <remarks>
